...
namespace Cardevil.InGame.Enemy
{
    public class Enemy : MonoBehaviour
    {
        ...
        public int attackCycle = 3; // 일단 기본 3, 몇번 마다 공격이 시행되는지?
        ...
        AttackStyle GetRandomAttackStyle() // 랜덤으로 어택스타일 받기
        {
            ...
            return (AttackStyle)values.GetValue(UnityEngine.Random.Range(0, values.Length));
        }

   
        void AttackNoticeSign_Point(int pointNumber_x,int poinNumber_y)
        {
