...
namespace Cardevil.Card.InWorld.UI.Selection
{
    public class SelectionPresenter
    {
        ...
        private readonly CardSelectionView _view;
        ...
        public SelectionPresenter(CardRepository repository, CardSelectionView view, int count)
        {
        ...
        public UniTask<UiFlowResult<int>> RequestSelectionAsync(Vector2 centerAnchor, CancellationToken cancellationToken = default)
        {
            return _view.RequestSelectionAsync(_dataList, centerAnchor, cancellationToken);
        }

        public UniTask<UiFlowResult<int>> WaitForSelectionAsync(CancellationToken cancellationToken = default)
        {
            return _view.WaitForSelectionAsync(cancellationToken);
        }

        public UniTask<UiFlowResult<int>> RequestSelectionAsync(
        ...
        {
            return _view.RequestSelectionAsync(_dataList, centerAnchor, colCount, colSpacing, rowSpacing, cancellationToken);
        }
