...
namespace Cardevil.Gameplay.Dungeon.UI
{
    ...
    public class DungeonChapterUI : MonoBehaviour
    {
        ...
        public Core.Dungeon Dungeon => CardevilCore.GameFlow.World.Dungeon.GetDungeonById(dungeonId);
        ...
        {
            Core.Dungeon dungeon = CardevilCore.GameFlow.World.Dungeon.GetDungeonById(dungeonId);
            if (dungeon == null)
            {
