...
namespace Cardevil.Gameplay.Relics.Effects
{
    ...
    public class ModifyStatDefinition : EffectDefinition
    {
        ...
        public override EffectRuntime CreateRuntimeInstance(IRelicContext context) =>
        ...
        public class Runtime : EffectRuntime, IStatModifier
        {
            ...
            public Runtime(ModifyStatDefinition definition, IRelicContext context) : base(context)
            {
