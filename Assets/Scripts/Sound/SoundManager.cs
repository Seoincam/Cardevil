...
namespace Cardevil.Sound
{
    ...
    {
        [Header("Settings")]
        [SerializeField] SerializableDict<string, AudioClip> _audioClips = new ();
        [SerializeField] private AudioMixer audioMixer;
        [SerializeField] public AudioMixerGroup[] audioMixerGroups;
        [Header("Config")]
        [SerializeField] private AudioConfigurationSO _backgroundAudioConfiguration;
        [SerializeField] private AudioConfigurationSO _soundEffectAudioConfiguration;
        
        [Header("Audio Sources")]
        [SerializeField] private SoundEmitter _BGMEmitter;
